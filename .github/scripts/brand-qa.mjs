...
try {
  for (const viewport of viewports) {
    ...
    const home = await page.evaluate(() => {
      ...
      return {
        ...
        frameworkOverlay: Boolean(document.querySelector('astro-dev-overlay, astro-dev-toolbar, vite-error-overlay, nextjs-portal')),
  ...
  const routes = ['/', '/services/', '/weddings/', '/events-nightlife/', '/about/', '/playlists/', '/mixes/', '/client-documents/', '/contact/', '/privacy/'];
  const routeResults = [];
